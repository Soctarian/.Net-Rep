...
namespace Controllers
{
    public class InputMatchInfo
    {
        ...
        public static void InputQuickMatchStatistic(int countMatches, decimal accountId)
        {
        ...
        public static void InputFullkMatchStatistic(decimal MatchId)
        {
            var HeroDictionary = HeroAndItemsDictionary.FillHeroDictionary();
        ...
        public static void InputDetailMatchStatistic(decimal MatchID, string Hero)
        {
